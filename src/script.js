class Todo {
  selectors = {
    ...
    emptyMassage: '[data-js-todo-item-empty-massage]',
  }
  ...
  constructor() {
    ...
    this.emptyMassageElement = this.rootElement.querySelector((this.selectors.emptyMassage))
    this.state = {
  ...
  render() {
    ...
    this.emptyMassageElement.textContent =
      isEmptyFilteredItems ? 'No tasks found'
